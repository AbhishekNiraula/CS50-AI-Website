				...
				<div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
						...
						<ul className="flex items-center space-x-3 mt-9">
							<li>
								<a
									href="#"
									title=""
									className="flex items-center justify-center text-white transition-all duration-200 bg-textBlue rounded-full w-7 h-7 hover:bg-primaryRed focus:bg-primaryRed">
									<svg
										className="w-4 h-4"
					...
					<div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
						...
						<ul className="mt-6 space-y-4 text-textBlue text-sm">
							...
							<li>
								<Button
									className="flex w-40 text-base rounded-md text-offWhite border-primaryPurple font-semibold bg-primaryPurple border-3 transition-all duration-500 hover:bg-offWhite hover:text-primaryPurple hover:border-primaryPurple px-6 py-3"
									as={Link}
									variant="flat">
									Get Started 🔥
								</Button>
